<script setup lang="ts">
  import { ref } from 'vue';
  import { PostPSearchParams, PostPageListItem } from '@/types/Human';
  ...
  const create = () => {};
  const batchDelete = () => {};
  const editStaff = (record: PostPageListItem) => {};
  const deleteStaff = (record: PostPageListItem) => {};
  const resetStaffPwd = (record: PostPageListItem) => {};
</script>
      ...
      <a-row>
        <a-col :flex="1" :model="formModel">
          ...
          >
            <a-row :gutter="16">
              <a-col :span="8">
                <a-form-item field="dictName" label="岗位编码">
                  <a-input
              ...
              <a-col :span="8">
                <a-form-item field="dictType" label="岗位名称 ">
                  <a-input
